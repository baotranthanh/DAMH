...
const AdminEditProduct = ({
  ...
  return (
    ...
    <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-'>
                             ...
                             return(
                               <div className='relative group'>
                                   <img 
                                     ...
                                     <div className='absolute bottom-0 right-0 p-1 text-white bg-green-600 rounded-full  group-hover:block cursor-pointer' onClick={()=>handleDeleteProductImage(index)}>
                                       <MdDelete/>  
                                     </div>
                               </div>
